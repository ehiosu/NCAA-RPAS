...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-700 dark:border-gray-700" aria-label="Sidebar">
   <div class="h-full px-3 pt-2 pb-4 overflow-y-auto bg-white dark:bg-gray-700">
                ...
                <hr />
                   ...
                   <div className='pt-6 space-y-6'>
                    ...
                    <div>
                        ...
                        <p className='hover:bg-gray-100 rounded-md cursor-pointer'>-Fresh Issue</p>
                        <p className='hover:bg-gray-100 rounded-md cursor-pointer'>-Variation</p>
                    </div>
                    <div>
