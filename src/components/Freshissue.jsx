let Freshissue = () => {
    return (
        ...
        <p className='text-2xl font-bold'>Basic Operations</p>
        </div>
        ...
        <div className="w-full p-6 bg-white border border-gray-200 rounded-lg relative">
        <div className="flex gap-5 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
        ...
        <p className='text-2xl font-bold'>Specific Operations</p>
        </div>
        ...
        <p className='text-2xl font-bold'>Complex Operations</p>
        </div>
